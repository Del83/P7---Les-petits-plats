export const recipes = [
  ...
  },
  {
    ...
    time: 50,
    description:
      "Commencez par mélanger les oeufs, le sucre et le sucre vanillé dans un saladier, découper les pommes en tranches, ajouter la crème fraîche aux oeufs. Une fois que tout est prêt, étalez la tarte dans le moule. N'oubliez pas de piquer le fond avec une fourchette avant de positionner les pommes sur la tarte. Finalement verser la préparation à base d'oeufs et de crême fraîche. Laisser cuire au four pendant 30 minutes",
    appliance: "Four",
  ...
  },
  {
    ...
    time: 50,
    description:
      "Etaler la pâte dans les moules à tartelette. Faire cuire la pâte 30 minutes. Découper le chocolat en morceau et le faire chauffer, y ajouter la crême liquide, ajouter le beurre et remuer jusqu'à avoir une pâte homogène. Verser la pâte dans les tartelettes. Couper les fraises en 2 et les positionner dedans.",
    appliance: "Four",
  ...
  },
  {
    ...
    time: 60,
    description:
      "Hachez les noix grossièrement. Faire fondre le chocolat avec le beurre. Mélanger les oeufs et le sucre, au chocolat. Ajouter la farine. Mélanger afin d'avoir quelque chose d'homogène puis incorporer les noix. Verser la préparation dans un moule de préférence rectangulaire. Cuire 2O à 25 minutes à 180°. Sortez du four et attendez quelques minutes pour démouler. Servir avec une boule de glace pour plus de gourmandise.",
    appliance: "Four",
  ...
  },
  {
    ...
    time: 15,
    description:
      "Peler le concombre, le couper en 2, retirer les pépins. Couper les olives en morceaux, ainsi que le fromage de chèvre. Ajouter le basilic ainsi que le vinaigre balsamic et l'huile d'olives à votre goût.",
    appliance: "Saladier",
  ...
  },
  {
    ...
    time: 60,
    description:
      "Commencer par cuire les pommes de terre dans l'eau bouillante. Puis épluchez-les et coupez-les en rondelles. Emincer les oignons puis les faire dorer dans du beurre. Ajouter le jambon fumé coupé en en morceaux ainsi que les pommes de terres. Salez, poivrez à votre goût (et celui de vos convives). Laissez cuisiner durant environ 10 minutes puis ajouter le vin blanc. Après 5 minutes, mettre le tout dans un plat à gratin. Coupez le rebelochon, soit en tranches, soit le couper en 2 dans le sens de l'épaisseur et recouvrir les pommes de terre. Cuire au four (environ 220°) durant 25 minutes. C'est prêt !",
    appliance: "Four",
  ...
  },
  {
    ...
    time: 40,
    description:
      "Cuire les pommes de terre environ 30 minutes. Découper les échalottes finement. Durant la cuisson des pommes de terre. Préparez la vinaigrette avec l'huile d'olive et le vinaigre de cidre. Salez, poivrez à discrétion. Dans un saladier, mettre la mâche. Ajouter les pommes de terres.",
    appliance: "Casserole",
  ...
  },
  {
    ...
    time: 100,
    description:
      "Mélanger la farine et les oeufs, faire fondre 25 grammes de beurre et ajouter à la pâte. Ajouter du sel. Laisser reposer 1 heure. Faire les galettes et laisser refroidire. Faire chauffer les saucisses avec du beurre et l'oignon. Enrouler les saucisses dans les crêpes avec une partie du fromage. Mettre le reste du fromage à raclette par dessus les crêpes. Passer au four pendant 20 minutes.",
    appliance: "Four",
  ...
  },
  {
    ...
    time: 45,
    description:
      "Faire cuire les pâtes si vous n'avez pas de pennes, des coquillettes peuvent faire l'affaire. Découper les tomates en petits morceaux, soit en tranches, soit en dés. Coupez le basilic en petits morceaux et mélangez-le aux tomates. Coupez la mozzarella en tranche. Préchauffez le four à 200°. Alternez entre couches de pâtes et couches de tomates, terminez par une couche de pâtes et recouvrir de fromage. Laisser au four 30 minutes et régalez vous! Une recette simple qui fera plaisir aux petits comme aux grands.",
    appliance: "Four",
  ...
  },
  {
    ...
    time: 15,
    description:
      "Coupez les fraises en morceaux, découpez la chair de la pastèque en retirant les pépins. Mettre le tout dans le blender. Ajouter une cuillière à soupe de jus de citron ainsi que les glaçons. Ajoutez quelques feuilles de menthe pour plus de fraicheur. Mixez le tout. Servir et déguster.",
    appliance: "Blender",
  ...
  },
  {
    ...
    time: 10,
    description:
      "Séparez 1/5ème d'Ananas (une belle tranche qui servira pour la décoration des verres), mettre le reste coupé en cubes dans le blender, ajouter la glace à la vanille et le lait. Mixez. Servir et décorer avec l'ananas restant. C'est prêt.",
    appliance: "Blender",
  ...
  },
  {
    ...
    time: 60,
    description:
      "Etaler la pâte dans un moule et la piquer. Parsemer de beurre. Faire chauffer les lardons dans une poêle. Battre les oeufs en ajoutant la crème fraîche et le lait. Finalement ajouter les lardons, salez, poivrez à votre goût. Verser l'ensemble sur la pâte. Cuire environ 50 minutes.",
    appliance: "Four",
  ...
  },
  {
    ...
    time: 30,
    description:
      "Faire fondre le beurre et le mélanger avec le sucre. Finalement ajouter l'oeuf. Ajouter la farine tout en mélangeant peu à peu pour avoir une masse sans grumeau. Ajouter les pépites de chocolat. Faire sur une plaque de cuisson de petites boules pour les cookies. Mettre au four à 180° pendant 10 minutes.",
    appliance: "Four",
  ...
  },
  {
    ...
    time: 25,
    description:
      "Verser de l'huile dans une cocotte minute, couper les légumes et les verser dans l'huile chaude. Laisser cuire et remuer pendant 10 minutes. Passer au mixer. Servir.",
    appliance: "Mixer",
  ...
  },
  {
    ...
    time: 60,
    description:
      "Mettre tous les ingrédients dans une cocotte. ajouter de l'eau pour recouvrir l'ensemble et laisser cuire à petit feu pendant 1 heure. Passer au mixer. Salez, poivrez. C'est prêt.",
    appliance: "Mixer",
  ...
  },
  {
    ...
    time: 20,
    description:
      "Beurrer les tranches de pain, ajouter entre 2 tranches de pain de mie, 1 tranche d'emmental, une de blanc de dinde, et une autre d'emmental. Dans un récipient, mélanger le gruyère rapé avec le lait et la noix de muscade. Mettre sur les croque monsieur. Placer au four durant 10 minutes.",
    appliance: "Four",
  ...
  },
  {
    ...
    time: 25,
    description:
      "Eplucher les patates douces et coupez les en morceaux. Les faire cuire durant 20 minutes dans une casserole d'eau bouillante. Passer au mixer en ajoutant la crème et l'huile d'olive à son goût. Salez, poivrez. Pressez l'orange et ajouter le jus à l'ensemble. Servir.",
    appliance: "Mixer",
  ...
  },
  {
    ...
    time: 35,
    description:
      "Raper les courgettes et les faire revenir durant 15 minutes. Ajouter le fromage de chèvre frais. Préparer la béchamel avec le lait et la maïzena. Salez, poivrez, ajouter de la noix de muscade selon les goûts. Dans un plat, mettre un peu de sauce au fond, puis des lasagnes, puis des courgettes, etc... terminer par de la sauce et ajouter le gruyère. Passer au four à 180° durant 20 à 25 minutes.",
    appliance: "Four",
  ...
  },
  {
    ...
    appliance: "Four",
    ustensils: ["couteau", "cuillère en bois", "Poële à frire"],
  },
  {
    id: 38,
    name: "Pain perdu",
  ...
  },
  {
    ...
    time: 60,
    description:
      "Commencez par préparer la mousse au chocolat au moins 2 heures avant. Quand la mousse est prête et à reposer. Alors mouiller les boudoirs dans le jus des poires. Disposer. Alterner : mousse au chocolat, boudoirs et poires. Mettre au frais.",
  ...
  },
  {
    ...
    time: 40,
    description:
      "Étaler la pâte a pizza. Ecraser les tomates pelées, les étaler sur la pâte, ajouter les lardons et les champignons. Ajouter le gruyère et passer au four à 220° durant 20 minutes.",
    appliance: "Four",
  ...
  {
    id: 50,
    name: "Galette des rois à la frangipane",
    servings: 2,
    ingredients: [
      {
        ingredient: "Pâte feuilletée",
    ...
    time: 60,
    description:
      "Préparer la frangipane : Mélanger le sucre, la poudre d'amande, le beurre et les oeufs. Etaler la moitier de la pâte feuilletée et mettre dans un moule à tarte. Garnir de frangipane et recouvrir du reste de pâte feuilletée. Mettre au four 30 minutes",
    appliance: "Four",
